...
describe('PgConnection', () => {
  ...
  beforeAll(() => {
    ...
    jest.mock(createConnection).mockImplementation(createConnectionSpy)
    jest.mock(getConnectionManager).mockImplementation(getConnectionManagerSpy)
    jest.mock(getConnection).mockImplementation(getConnectionSpy)
    jest.mock(getRepository).mockImplementation(getRepositorySpy)
  })
